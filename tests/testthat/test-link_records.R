...
test_3a$pids_1 <- link_records(attribute = test_3a$cri_1, probabilistic = FALSE)$pid
test_3a$pids_2 <- link_records(attribute = test_3a$cri_2, probabilistic = FALSE)$pid
test_3a$pids <- merge_ids(test_3a$pids_1, test_3a$pids_2)

test_3b$pids_1 <- link_records(attribute = test_3b$cri_1, probabilistic = FALSE)$pid
test_3b$pids_2 <- link_records(attribute = test_3b$cri_2, probabilistic = FALSE)$pid
...
test_4a <- df_4a
test_4a$pids_1 <- link_records(attribute = test_4a$cri_1, probabilistic = FALSE)$pid
test_4a$pids_2 <- link_records(blocking_attribute = test_4a$cri_2, attribute = list(test_4a$cri_2a, test_4a$cri_2b, test_4a$cri_2c), probabilistic = FALSE)$pid
