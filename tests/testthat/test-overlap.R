...
test_that("test compress function", {
  ...
  expect_error(diyar::compress(diyar::number_line(1, 20), diyar::number_line(5, 7), diyar::number_line(1,20), method = "crossing"), "`method` must be either 'across','chain','aligns_start','aligns_end' or 'inbetween'")
