...
+ Updated argument in `links()`- `recursive`. This is now takes any of four options `[c("linked.false", "linked.true", "unlinked", "none")]` .
`[c("linked.false", "linked.true", "unlinked")]` is the equivalent of the old `[TRUE]` option, while `["none"]` is the equivalent of the old `[FALSE]` option.
