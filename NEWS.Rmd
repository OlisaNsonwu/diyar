...
+ New function - `schema()`. Plot schema diagrams for `pids`, `epids` and `number_line` objects.
...
+ `fixed_episodes()` and `rolling_episodes()` are retired and no longer supported.
