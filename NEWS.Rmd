...
+ New function - `episodes_wf_splits()`. Wrapper function of `episodes()` for better optimised handling of duplicates records. 
+ New function - `concat_code()`. Numeric codes for unique concatenation of strings.
