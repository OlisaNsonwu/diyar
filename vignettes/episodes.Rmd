...
schema(event_dt$ep1, seed = tmp.seed, show_labels = c("case_nm", "length_arrow"))
schema(event_dt$ep3, seed = tmp.seed, show_labels = c("case_nm", "length_arrow"))
schema(event_dt$ep4, seed = tmp.seed, show_labels = c("case_nm", "length_arrow"))
```
...
```{r warning=FALSE, fig.width=7}
schema(event_dt$ep6, seed = tmp.seed, show_labels = c("length_arrow"), 
       custom_label = paste0(decode(event_dt$ep6@case_nm), " (", event_dt$attr_1, ")"))
schema(event_dt$ep7, seed = tmp.seed, show_labels = c("length_arrow"), 
...
```{r warning=FALSE, fig.width=7}
schema(event_dt$ep8, seed = tmp.seed, show_labels = c("length_arrow"), 
       custom_label = paste0(decode(event_dt$ep8@case_nm), " (", event_dt$attr_1, ")"))
schema(event_dt$ep9, seed = tmp.seed, show_labels = c("length_arrow", "length"))
```
...
schema(dfr$ep1, seed = tmp.seed, show_labels = "length_arrow")
schema(dfr$ep2, seed = tmp.seed, show_labels = "length_arrow")
```
...
```{r warning=FALSE, fig.width=7}
schema(event_dt$ep10, seed = tmp.seed, show_labels = c("length_arrow"),
...
```{r warning=FALSE, fig.width=7}
schema(event_dt$ep11, seed = tmp.seed, show_labels = c("length_arrow"),
       custom_label = paste0(event_dt$attr_1, " in ", event_dt$attr_2))
```
...
```{r warning=FALSE, fig.width=7}
schema(event_dt$ep12, seed = tmp.seed, show_labels = c("length_arrow"),
       custom_label = paste0(event_dt$attr_1, " in ", event_dt$attr_2))
```
