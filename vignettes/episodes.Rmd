...
In general, this issue can be mitigated by reducing the number of iterations required to complete the episode tracking process. There are three main ways of achieving this. These are summarised below. 
