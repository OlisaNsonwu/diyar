...
***NOTE; `to_s4` and `to_s4()` changes these functions' output from a data.frame (current default) to `epid` objects. `epid` objects will become the default output in the next major release.***
