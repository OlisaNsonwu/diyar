...
rolling_episodes$dt_a <- start_point(rolling_episodes$epid_interval)
rolling_episodes$dt_z <- end_point(rolling_episodes$epid_interval)

fixed_episodes$dt_a <- start_point(fixed_episodes$epid_interval)
fixed_episodes$dt_z <- end_point(fixed_episodes$epid_interval)
