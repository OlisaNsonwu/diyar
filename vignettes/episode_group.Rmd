...
`fixed_episodes()`, `rolling_episodes()` and `episode_group()` provide simple but flexible ways of doing this. They group events into temporal episodes which then allows for easy deduplication or a sub-analysis within each episode.
