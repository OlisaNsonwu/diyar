...
# Track diagnoses 6 months AFTER the HIV diagnosis.
  # `bi_direction` tells the function to also check 6 months BEFORE the HIV diagnosis
...
# Track diagnoses 6 months BEFORE the HIV diagnosis
  # bi_direction` tells the function to also check 6 months AFTER the HIV diagnosis
...
# Track diagnoses between 2 and 6 months AFTER the HIV diagnosis. 
  #` bi_direction` tells the function to also check between 2 and 6 months BEFORE the HIV diagnosis
