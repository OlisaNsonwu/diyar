...
#Introduction
Deduplicating events is a main part of establishing a case definition in epidemiological analysis. In these analysis, a reference event is selected and considered the start of an episode, while subequent events within a specified period are considered duplicates.
...
hospital_admissions_2$admin_period <- int_shift(hospital_admissions_2$admin_period, duration(hospital_admissions_2$shift, "days"))
