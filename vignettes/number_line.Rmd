...
```{r echo=FALSE, fig.height=2.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(rev(c(nl_c, nl_d, nl_e, nl_f, nl_g, nl_h, nl_i)))
```
...
number_line_sequence(nls, by = 2 * nls@.Data/abs(nls@.Data))
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(exact, deduplicate =F, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(inbetween, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(aligns_start, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(aligns_end, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(c(a,b,c$n1, c$n2), show_overlap=F)
```
...
```{r echo=FALSE, fig.height=2.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(f, deduplicate =F, show_overlap=T)
```
...
```{r echo=FALSE, fig.height= 2, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(nl_z, deduplicate =F, show_overlap=T)
```
...
```{r echo=FALSE, fig.height= 2, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(cmp_z, deduplicate =F, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(cmp_zb, deduplicate =F, show_overlap=T)
```
...
```{r echo=FALSE, fig.height=1.5, fig.width=8.5, message=FALSE, warning=FALSE}
sch_nl(cmp_zba, deduplicate =F, show_overlap=T)
```
