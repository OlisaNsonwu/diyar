...
patient_list_2$pids_a <- links(sn = patient_list_2$rd_id, 
                               criteria = list(patient_list_2$forename, patient_list_2$surname, patient_list_2$sex), 
                               display = "none")
...
patient_list_2$pids_b <- links(criteria = list(patient_list_2$forename, patient_list_2$surname), 
                               display = "none")
...
patient_list_2$pids_e <- links(sn = patient_list_2$rd_id, 
                               criteria = list(patient_list_2$forename, patient_list_2$soundex),
                               display = "none")
...
Opes_c$pids_a <- links(criteria = "place_holder",
                       sub_criteria = list(cr1 = sub_criteria(Opes_c$range_a, funcs = diyar::range_match_legacy)),
                       display ="none")
...
Opes_c$pids_b <- links(criteria = "place_holder",
                       sub_criteria = list(cr1 = sub_criteria(Opes_c$range_b, funcs = diyar::range_match_legacy)),
                       display = "none")
