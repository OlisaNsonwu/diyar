...
#' @param group_stats \code{[character]}. Return episode-specific information in \code{\link[=epid-class]{epid}} \code{"slots"}. Options are any combination of \code{"case_nm"}, \code{"wind"} and \code{"epid_interval"}.
