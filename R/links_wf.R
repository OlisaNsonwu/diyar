...
#' @param blocking_attribute \code{[atomic]}. See \bold{\code{criteria}} in \bold{\code{\link{links}}}.
#' @param repeats_allowed \code{[logical]} See \bold{\code{repeats_allowed}} in \bold{\code{\link{links}}}.
#' @param permutations_allowed \code{[logical]} See \bold{\code{permutations_allowed}} in \bold{\code{\link{links}}}.
#' @param ignore_same_source \code{[logical]} See \bold{\code{ignore_same_source}} in \bold{\code{\link{links}}}.
#' @param data_source \code{[character]}. See \bold{\code{data_source}} in \bold{\code{\link{links}}}.
#' @param display \code{[character]}. See \bold{\code{display}} in \bold{\code{\link{links}}}.
