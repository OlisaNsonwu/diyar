...
The `diyar` package aims to provide a simple and flexible implementation of mutlistage deterministic record linkage and episode grouping for the application of case definitions in epidemiological analysis.
