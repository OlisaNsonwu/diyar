...
The `diyar` package aims to provide a simple and flexible implementation of multi-stage deterministic record linkage and episode grouping.
...
## Usage
There are two main aspects of the `diyar` package; multi-stage data linkage grouping (`links()`) and episode tracking (`episodes()`). `number_line` objects are used in both.
